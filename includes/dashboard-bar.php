   ...
   <aside
      ...
      >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul class="mt-6">
            <li class="relative px-6 py-3 dashboard-nav-link ">
              <!-- <span
          ...
          <ul>
            ...
            ?>
            <li class="relative px-6 py-3 jobs-nav-link">
              <a
           ...
           <li class="relative px-6 py-3 companies-nav-link">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="?page=companies"
              >
            ...
            if($_SESSION['usr_role'] == 'company'){
              ...
              $select_title_logo = mysqli_query($connection,$query);
              checkQuery($select_title_logo);
              while($row = mysqli_fetch_assoc($select_title_logo)){
          ...
          <li class="relative px-6 py-3 organization-nav-link">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
             ...
             ?>
              <img class="logo_company_img" style="width:30px;" src="uploads/<?php echo $company_logo ?>" alt="">
               <?php
              }
              ?>
                <!-- #organization logo -->
                ...
                <span class="ml-4 text-truncate"><?php echo $company_title; ?></span>
              </a>
            </li>
            ...
            if($_SESSION['usr_role'] == 'job_seeker'){
              ?>
              <li class="relative px-6 py-3 applications-nav-link">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              ...
              <li class="relative">
                ...
                >
                  <img
                    ...
                    src="assets/img/avatar_placeholder.webp"
                    alt=""
                    aria-hidden="true"
                  />
                </button>
